...
<%--
        <div class="input-group mb-3"><input type="email" class="form-control col-3 text-center" name="code" placeholder="Your email" aria-label="Code" aria-describedby="basic-addon1" required></div>
--%>
        <div class="input-group mb-3"><input type="text" class="form-control col-3 text-center" name="newPassword" placeholder="New password" aria-label="Password" aria-describedby="basic-addon1" required></div>
        <div class="input-group mb-3"><input type="text" class="form-control col-3 text-center" name="confirmPassword" placeholder="Confirm password" aria-label="Confirm password" aria-describedby="basic-addon1" required></div>
